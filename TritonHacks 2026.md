...
Throughout the two days, CS Foreach members/alumni and various UC San Diego clubs hosted workshops, allowing students to independently explore diverse topics in computing. Workshops included *Evidence-Based Brainstorming/Ideation*, *API Integration*, *AI Safety*, *Game Development in Roblox Studio*, *Virtual Reality (VR) in Unity*, *Computer Vision*, and *Feature Engineering for Quantitative Trading*. Additionally, students were given one-on-one assistance on their programming projects with mentors that provided regular check-ins and technical assistance.
